    ...
    <main className="min-h-screen bg-gray-50 pb-12">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {productos.map((p) => (
            <article key={p.id} className="bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300">
              <img src={p.imagenUrl} alt={p.nombre} className="w-full h-56 object-cover" />
              <div className="p-6">
                ...
                <div className="flex items-center justify-between mt-6">
                  ...
                  <a href={p.linkAmazon} target="_blank" rel="noopener" className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-lg transition-colors">
                    Comprar
                  </a>
                </div>
              </div>
