...
export default function PostPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Modal de Imagen Maximizada (Zoom) */}
      {isZoomed && (
        <div 
      ...
      <article className="pt-32 pb-20 px-4 max-w-3xl mx-auto">
        ...
        <header className="mb-12">
          ...
          {/* Imagen con Zoom al clickear */}
          <div 
            className="rounded-[2.5rem] overflow-hidden bg-gray-50 aspect-video mb-12 shadow-xl border border-gray-100 cursor-zoom-in group"
        ...
        <p className="text-gray-900 font-medium mb-12">
          En Hogar Conectado creemos que la tecnología debe facilitarte la vida, no complicarla. Por eso, siempre recomendamos productos que hemos analizado a fondo y que ofrecen una experiencia real de mejora.
        </p>
