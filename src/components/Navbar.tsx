    ...
    <nav className="fixed top-0 w-full z-50 bg-white/90 backdrop-blur-sm border-b border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2">
          ...
          <span className="text-lg font-bold tracking-tight">hogar<span className="text-brand">conectado</span></span>
        </Link>
        <div className="flex gap-4 items-center">
          <Link href="/#productos" className="text-sm font-semibold text-brand">Catálogo</Link>
        </div>
      </div>
    </nav>
  );
